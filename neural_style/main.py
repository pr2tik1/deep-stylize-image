...
st.write("Stylize your Image from the available styles. Just choose from the options in the sidebar and click '**stylize**'. \
    This app uses style transfer deep learning technique. To know more follow the model training and code visit [here](https://github.com/pytorch/examples/tree/master/fast_neural_style).")
...
st.write("To save: Right click -> Save Image as")